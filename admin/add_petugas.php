...
<div class="box">
<form method="post" action="password_petugas.php" class="mw-50 needs-validation shadow-lg p-3 h-auto d-inline-block rounded-2" style="width:500px; height: 700px">
  <div class="mb-1">
