        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <div class="row row-cols-lg-4 g-4 g-lg-3">
                        <div class="col d-inline-block bg-warning m-2">
                            <h6>Pinjaman Paket Crypto</h6>
                        </div>
                        <div class="col d-inline-block bg-warning m-2">
                            <h6>Pinjaman Paket Nikah</h6>
                        </div>
                        <div class="col d-inline-block bg-warning m-2">
                            <h6>Pinjaman Paket beliNinja</h6>
                        </div>
                    </div>
                </div>
            </main>
